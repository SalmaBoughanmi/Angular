...
@Component({
  selector: 'app-trait-rh',
  templateUrl: './trait-rh.component.html',
  styleUrls: ['./trait-rh.component.css']
})
export class TraitRhComponent implements OnInit{
  demande_id:any;
  employe_id:any;
  ...
  New_Form = new FormGroup({
    ...
    motif_rh:new FormControl("", [Validators.required]),
  })
   accepter(){
