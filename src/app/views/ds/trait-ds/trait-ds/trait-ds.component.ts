...
@Component({
  selector: 'app-trait-ds',
  templateUrl: './trait-ds.component.html',
  styleUrls: ['./trait-ds.component.css']
})
export class TraitDsComponent  implements OnInit{
  demande_id:any;
  employe_id:any;
  ...
  New_Form = new FormGroup({
    ...
    motif_ds:new FormControl("", [Validators.required]),
  })
   accepter(){
